...
**Version 1.1 — Validated Proof-of-Concept Specification — August 8, 2026**
...
The proof of concept covers Fall 2024, Spring 2025, Fall 2025, and Spring 2026. It retains semester detail and reports primarily by academic year. The intended future expansion is Fall 2019 through Spring 2026, excluding summers.
...
The current approved exception is Spring 2026 `CIVENG 153 | CYPLAN 190-002`. Both primary listings are fixed at three units even though the CYPLAN source record carries a variable-unit attribute. The activity includes 41 CIVENG students and 10 CYPLAN students:

**(41 + 10) × 3 = 153 SCH**

All 153 SCH are attributed to Marta Gonzalez. The pipeline must fail rather than apply this override if refreshed source unit values cease to equal three.

### 6.4 CIVENG 190 policy exclusion
...
This exclusion applies only to exact `CIVENG 190`. It does not apply to `CIVENG 190S`, `CYPLAN 190`, or other subjects/catalog numbers containing 190.
...
Simultaneous sections that represent one instructional activity may be grouped through explicit configuration. Approved proof-of-concept cases include:
...
The current roster is assumed affiliated in all four proof-of-concept terms, including terms with zero teaching, leave, sabbatical, or other non-teaching status.

### 10.2 Supplemental instructors

Reviewed historical or non-roster CEE instructors are added with term-specific affiliations. The current configuration adds eight NON-REGULAR instructors. They enter the numerator and denominator only in approved affiliated semesters.
...
10. Apply the exact CIVENG 190 policy exclusion.
...
- all exact CIVENG 190 activity SCH is zero with `COURSE_POLICY_EXCLUSION`;
...
- disclose early enrollment observations, variable-unit exclusions, and exact CIVENG 190 policy exclusions.

The dashboard must visibly state that all CIVENG 190 pilot-course sections are excluded.
...
3. All exact CIVENG 190 offerings are excluded as heterogeneous pilot-course sections.
...
1. all four terms are represented;
...
6. variable-unit and CIVENG 190 exclusions are explicit;
